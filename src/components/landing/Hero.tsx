      ...
      <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-center pt-32 px-6" style={{ overflow: "visible" }}>
        ...
        >
          ...
          <div className="flex items-center justify-center mt-10">
            <a href="/login" className="relative group rounded-full">
              <span className="absolute -inset-0.5 bg-gradient-to-r from-[#34C759] to-[#007AFF] rounded-full blur opacity-75 group-hover:opacity-100 transition duration-200"></span>
              <span className="relative flex items-center justify-center px-10 py-4 bg-[var(--bg-primary)] rounded-full text-[var(--text-primary)] font-bold tracking-wide border border-[var(--separator)] group-hover:bg-[var(--fill-secondary)] transition-colors shadow-xl text-lg">
                Get Started →
              </span>
            </a>
          </div>
